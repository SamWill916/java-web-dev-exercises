...
public class QuizRunner {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> correctAns1 = new ArrayList<>(Arrays.asList(2));
        ...
        MultipleChoice newQuestion2 = new MultipleChoice(1, "Who won the Halloween Costume Contest?", 1, possAns2);
